...
const { index, show, store, update, destroy, search } = require('../controllers/user.controller');
...
router.post('/',[
    ...
    check('birthday', 'La fecha de nacimiento es incorrecta.').isDate({format: 'DD-MM-YYYY'}).optional(),
    validarCampos,
], store );
